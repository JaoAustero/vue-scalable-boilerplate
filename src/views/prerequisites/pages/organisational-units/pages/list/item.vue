...
export default {
    name: 'OrganizationUnitTableItem',
    ...
    methods:
    {
        ...
        onDeleteItem()
        {
            ...
            const content = {
                ...
                description: `Are you sure do you want to delete ${this.item.name} Organization Unit? Once you delete it, all flags that has relationship will be also deleted.`,
                module: 'organisationalUnit/sampleDestroy',
            };
