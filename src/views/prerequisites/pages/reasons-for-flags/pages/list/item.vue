...
export default {
    ...
    methods:
    {
        ...
        onDeleteItem()
        {
            ...
            const content = {
                title: 'Delete reason for flag?',
                description: `Are you sure do you want to delete ${this.item.name} reason for flag? Once you delete it, all flags that has relationship will be also deleted.`,
                module: 'reasonsForFlag/sampleDestroy',
            };
