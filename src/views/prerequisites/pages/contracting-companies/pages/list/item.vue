...
export default {
    name: 'ContractingCompanyTableItem',
    ...
    methods:
    {
        ...
        onDeleteItem()
        {
            ...
            const content = {
                title: 'Delete contracting company?',
                description: `Are you sure do you want to delete ${this.item.name} company? Once you delete it, all flags that has relationship will be also deleted.`,
                module: 'contractingCompany/sampleDestroy',
            };
