    ...
    methods:
    {
        ...
        onDeleteItem()
        {
            ...
            const content = {
                ...
                description: `Are you sure do you want to delete ${this.item.name} insurance type? Once you delete it, all flags that has relationship will be also deleted.`,
                module: 'insuranceType/sampleDestroy',
            };
