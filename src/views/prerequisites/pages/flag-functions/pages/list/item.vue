...
export default {
    ...
    methods:
    {
        ...
        onDeleteItem()
        {
            ...
            const content = {
                title: 'Delete flag function?',
                description: `Are you sure do you want to delete ${this.item.name} flag function? Once you delete it, all flags that has relationship will be also deleted.`,
                module: 'flagFunction/sampleDestroy',
            };
