...
export default {
    ...
    methods:
    {
        ...
        onDeleteItem()
        {
            ...
            const content = {
                title: 'Delete insurance status?',
                description: `Are you sure do you want to delete ${this.item.name} insurance status? Once you delete it, all flags that has relationship will be also deleted.`,
                module: 'insuranceStatus/sampleDestroy',
            };
