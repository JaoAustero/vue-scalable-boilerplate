...
export default {
    ...
    methods:
    {
        ...
        onDeleteItem()
        {
            ...
            const content = {
                title: 'Delete liability type?',
                description: `Are you sure do you want to delete ${this.item.name} liability type? Once you delete it, all flags that has relationship will be also deleted.`,
                module: 'liabilityType/sampleDestroy',
            };
